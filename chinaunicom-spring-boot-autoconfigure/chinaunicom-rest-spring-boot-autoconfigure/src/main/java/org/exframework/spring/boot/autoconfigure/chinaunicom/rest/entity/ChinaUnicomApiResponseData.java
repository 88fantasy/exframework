...
public class ChinaUnicomApiResponseData<T> extends ChinaUnicomApiResponse {
    ...
    @SuppressWarnings("rawtypes")
    public static final ChinaUnicomApiResponseData PARAM_ERROR = new ChinaUnicomApiResponseData<>(ResultCode.BAD_REQUEST, GlobalControllerExceptionControllerAdvice.PARAMS_ERROR, null);
