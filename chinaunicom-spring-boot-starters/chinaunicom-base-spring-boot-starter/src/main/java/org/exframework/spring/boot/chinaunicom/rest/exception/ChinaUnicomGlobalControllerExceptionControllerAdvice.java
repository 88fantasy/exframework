package org.exframework.spring.boot.chinaunicom.rest.exception;
...
public class ChinaUnicomGlobalControllerExceptionControllerAdvice {
    ...
    public ChinaUnicomApiResponseData<Object> exceptionHandler(InvalidFormatException e) {
        errorHandle(e);
        return new ChinaUnicomApiResponseData<>(ResultCode.NOT_ACCEPTABLE, "格式错误:" + e.getMessage(), null);
    }
    ...
    public ChinaUnicomApiResponseData<Object> exceptionHandler(Exception e) {
        errorHandle(e);
        return new ChinaUnicomApiResponseData<>(ResultCode.INTERNAL_SERVER_ERROR, e.getMessage(), null);
    }
