...
public class CosAutoConfigure {
	...
	public CosClient exframeCosClient() {
		...
		if (StringUtils.hasLength(secretId) && StringUtils.hasLength(secretId) && StringUtils.hasLength(secretId)
				&& StringUtils.hasLength(secretId) && StringUtils.hasLength(secretId)) {
