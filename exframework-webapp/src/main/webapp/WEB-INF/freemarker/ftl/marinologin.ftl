...
<head>
	...
	<![endif]-->
	<!-- 全局css -->
	<link href="${basePath}/css/plugins/bootstrap/bootstrap.min.css"
		rel="stylesheet">
	<link
	...
	<link rel="stylesheet" href="${basePath}/css/prototype/marino/main.css">
...
<body data-layout="empty-layout" data-palette="palette-0"
	...
	<script
		src="${basePath}/js/plugins/bootstrap/ie10-viewport-bug-workaround.js"></script>
