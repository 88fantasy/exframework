...
public class RowCheckerMetaObjectHandler implements MetaObjectHandler {
    ...
    private void fill(MetaObject metaObject) {
        ...
        if (o != null) {
            ...
            ReflectionUtils.doWithFields(clazz, field -> {
                        ...
                        Class<? extends Function<Object, CheckerResult>> f = checker.value();
                        Class<? extends RuntimeException> exception = checker.exception();
                        Function<Object, CheckerResult> function = SpringContextUtils.getBeanByClass(f);
                        Object value = getFieldValByName(field.getName(), metaObject);
                        CheckerResult result = function.apply(value);
