...
public class OptionResult {
	...
	public static OptionResult error(String errormsg) {
		return new OptionResult(Response.Status.INTERNAL_SERVER_ERROR.getStatusCode(),errormsg,null);
	}
