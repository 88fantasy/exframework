...
public interface TencentCosUpLoadClient  extends TencentCosClient {
	 ...
	 */
	default UploadResult upload(File file, String targetUrl) throws CosServiceException, CosClientException, InterruptedException {
		PutObjectRequest request = new PutObjectRequest(getBucketName(), targetUrl, file).withMetadata(DEFAULT);
